    ...
    return (a, r) => {
      ...
      return i(), h("div", A, [
        e.data.type === "object" || e.data.type === "array" ? (i(), h("div", E, [
          ...
          (i(!0), h(q, null, K(e.data.children, (f) => J((i(), N(k, {
            onSelected: b,
            key: S(f),
            data: f,
            maxDepth: e.maxDepth,
...
}), U = /* @__PURE__ */ O(Q, [["__scopeId", "data-v-5b340177"]]);
export {
  U as JSONView
};

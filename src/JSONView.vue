...
// const isDarkMediaQuery = window.matchMedia('(prefers-color-scheme: dark)').matches;
...
const itemSelected = (data: object): void => {
  emit('selected', data);
};
...
// const hasSelectedListener = computed((): boolean => {
